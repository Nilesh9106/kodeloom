...
import { MdAccessTimeFilled, MdGroups, MdManageAccounts } from "react-icons/md";
    ...
    <>
      <section className="flex max-sm:flex-col my-16  xl:px-28 lg:px-20 md:px-10 px-5">
        <div className="flex sm:flex-1 flex-col max-sm:items-center max-sm:text-center p-2 gap-4">
          <h1 className="xl:text-6xl lg:text-5xl md:text-4xl sm:text-3xl text-2xl font-bold   lg:leading-tight">
            Welcome to <span className="text-violet-500">Kodeloom</span>{" "}
            Transform chaos into clarity!
          </h1>
          <p className="text-xl dark:text-neutral-300 text-neutral-700">
            Unleash the Power of Seamless Collaboration and Effortless Project
            Management
          </p>
          <Button
            as={Link}
...
const Features = () => {
  const features = [
    ...
    },
    {
      ...
      icon: <MdManageAccounts className="flex-shrink-0 w-7 h-7 text-white" />,
    },
    {
      title: "Time Tracking",
...
export default function LandingPage() {
  return (
    <>
      ...
      <Hero />
      <div className="">
        <h2 className="text-4xl leading-tight font-bold text-center">
          Key Features
        </h2>
      </div>
      <Features />
      <section className="py-16 border-t-1 dark:border-neutral-800 dark:bg-neutral-950/80">
        <div className="container mx-auto text-center">
          <h2 className="text-4xl leading-relaxed font-bold mb-4">
            Ready to Streamline Your Projects?
          </h2>
          <p className="text-lg dark:text-neutral-400  mb-8">
            Join thousands of teams using our platform to achieve project
            management success.
          </p>
